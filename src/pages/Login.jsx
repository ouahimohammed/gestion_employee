...
import { auth, signInWithEmailAndPassword } from "../components/firebase"  // Import Firebase
import "bootstrap/dist/css/bootstrap.min.css"

const Login = () => {
  const [email, setEmail] = useState("")
  const [password, setPassword] = useState("")
  const [error, setError] = useState("")  // Pour afficher des erreurs
  const navigate = useNavigate()

  const handleLogin = async (e) => {
    e.preventDefault()
    setError("")  // Réinitialiser les erreurs à chaque tentative de connexion
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Gérez les <span style={{ color: "#FFD700" }}>absences</span> de vos 
            employés facilement
          </small>
        </div>
